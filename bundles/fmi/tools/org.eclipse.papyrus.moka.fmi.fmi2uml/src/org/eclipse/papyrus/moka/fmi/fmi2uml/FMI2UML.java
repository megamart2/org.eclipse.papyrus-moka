...
public class FMI2UML {
	...
	public static Class getFMUClass(FmiModelDescriptionType modelDescription, Package receivingPackage){
		if (modelDescription ==null || receivingPackage == null ){
		...
		FMU2UMLTransformation transformation = new FMU2UMLTransformation(modelDescription, receivingPackage);
