...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Data Value Set</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.papyrus.moka.datavisualization.profile.impl.DataValueSetImpl#getMetadata <em>Metadata</em>}</li>
 *   <li>{@link org.eclipse.papyrus.moka.datavisualization.profile.impl.DataValueSetImpl#getSeries <em>Series</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DataValueSetImpl extends MinimalEObjectImpl.Container implements DataValueSet {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @ordered
	 */
	protected EList<ValueSeries> series;
	...
	protected EClass eStaticClass() {
		return VisualizationPackage.Literals.DATA_VALUE_SET;
	}
	...
	public void setMetadata(String newMetadata) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VisualizationPackage.DATA_VALUE_SET__METADATA, oldMetadata, metadata));
	}
	...
	public EList<ValueSeries> getSeries() {
		if (series == null) {
			series = new EObjectContainmentEList<ValueSeries>(ValueSeries.class, this, VisualizationPackage.DATA_VALUE_SET__SERIES);
		}
		return series;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case VisualizationPackage.DATA_VALUE_SET__SERIES:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case VisualizationPackage.DATA_VALUE_SET__METADATA:
				return getMetadata();
			case VisualizationPackage.DATA_VALUE_SET__SERIES:
				return getSeries();
		}
